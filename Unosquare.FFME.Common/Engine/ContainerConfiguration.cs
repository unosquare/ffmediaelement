namespace Unosquare.FFME.Engine
{
    ...
    public sealed class ContainerConfiguration
    {
        ...
        /// </summary>
        public ReadOnlyCollection<OptionMeta> GlobalOptionsMeta { get; } = MediaEngine.InputFormatOptionsGlobal;

        /// <summary>
        /// Retrieves a dictionary of private options available to each of the registered demuxers.
        /// </summary>
        public ReadOnlyDictionary<string, ReadOnlyCollection<OptionMeta>> PrivateOptionsMeta { get; } = MediaEngine.InputFormatOptions;
    }
}
